		...
		return (
			<div className="page-content">
				...
				<div className="contact-block">
					...
					что бы вы выбрали нас в качестве технического
					исполнителя для создания единого риелторского
					фида (ЕРФ) вашего города.
					<br/><br/>
					Заполните форму для получения подробной информации
					о ЕРФ и его преимуществах для вас лично и для всех
					риелторов вашего региона.</p>
					</div>
